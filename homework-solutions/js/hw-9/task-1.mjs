...
for (let i = 0; i < keyValuePairs.length; i++) {
  console.log(`key = ${keyValuePairs[i][0]}, value = ${keyValuePairs[i][1]}`);
}

// 4
let hasSalaryKey1stOption = 'salary' in character;
// console.log(`hasSalaryKey1stOption ===> ${hasSalaryKey1stOption}`);


let hasSalaryKey2ndOption = Object.hasOwn(character, 'salary');

// let hasGenderKey2ndOption = Object.hasOwn(character, 'gender');
// console.log(`hasSalaryKey2ndOption ===> ${hasSalaryKey2ndOption}`);
// console.log(`hasGenderKey2ndOption ===> ${hasGenderKey2ndOption}`);
